# -*- coding: utf-8 -*-
"""
Created on Fri Mar 09 10:50:05 2018
...
def main(argv):
    ...
    reshape = Reshape((128, 1, 1), name = 'reshape')(apply_attention) 
    #branching convolutions
    ngram_2 = Convolution2D(200, 2, 1, border_mode='valid',activation='relu', name = 'conv_2')(reshape)
    maxpool_2 = MaxPooling2D(pool_size=(128-2+1,1), name = 'pooling_2')(ngram_2)
    ngram_3 = Convolution2D(200, 3, 1, border_mode='valid',activation='relu', name = 'conv_3')(reshape)
    maxpool_3 = MaxPooling2D(pool_size=(128-3+1,1), name = 'pooling_3')(ngram_3)
    ngram_4 = Convolution2D(200, 4, 1, border_mode='valid',activation='relu', name = 'conv_4')(reshape)
    maxpool_4 = MaxPooling2D(pool_size=(128-4+1,1), name = 'pooling_4')(ngram_4)
    ngram_5 = Convolution2D(200, 5, 1, border_mode='valid',activation='relu', name = 'conv_5')(reshape)
    maxpool_5 = MaxPooling2D(pool_size=(128-5+1,1), name = 'pooling_5')(ngram_5)
    #1 branch again
