...
def main(argv):
    ...
    maxpool_2_3_attention = Attention()([maxpool_2, maxpool_3])
    maxpool_3_4_attention = Attention()([maxpool_3, maxpool_4])
    maxpool_4_5_attention = Attention()([maxpool_4, maxpool_5])
    maxpool_5_2_attention = Attention()([maxpool_5, maxpool_2])
    #1 branch again
