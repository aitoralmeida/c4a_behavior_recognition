...
def main(argv):
    ...
    ngram_2_3_attention = Attention(dropout=0.8, causal=True)([ngram_2, ngram_3])
    ngram_3_4_attention = Attention(dropout=0.8, causal=True)([ngram_3, ngram_4])
    ngram_4_5_attention = Attention(dropout=0.8, causal=True)([ngram_4, ngram_5])
    ngram_5_2_attention = Attention(dropout=0.8, causal=True)([ngram_5, ngram_2])
    maxpool_2 = MaxPooling2D(pool_size=(INPUT_ACTIONS,1), name = 'pooling_2')(ngram_2_3_attention)
    maxpool_3 = MaxPooling2D(pool_size=(INPUT_ACTIONS,1), name = 'pooling_3')(ngram_3_4_attention)
    maxpool_4 = MaxPooling2D(pool_size=(INPUT_ACTIONS,1), name = 'pooling_4')(ngram_4_5_attention)
    maxpool_5 = MaxPooling2D(pool_size=(INPUT_ACTIONS,1), name = 'pooling_5')(ngram_5_2_attention)
    #1 branch again
