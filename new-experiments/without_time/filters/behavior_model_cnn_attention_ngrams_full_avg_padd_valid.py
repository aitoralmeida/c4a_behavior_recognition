...
def main(argv):
    ...
    maxpool_2 = MaxPooling2D(pool_size=(INPUT_ACTIONS-5+1,1), name = 'pooling_2')(ngram_average_2)
    maxpool_3 = MaxPooling2D(pool_size=(INPUT_ACTIONS-5+1,1), name = 'pooling_3')(ngram_average_3)
    maxpool_4 = MaxPooling2D(pool_size=(INPUT_ACTIONS-5+1,1), name = 'pooling_4')(ngram_average_4)
    maxpool_5 = MaxPooling2D(pool_size=(INPUT_ACTIONS-5+1,1), name = 'pooling_5')(ngram_average_5)
    #1 branch again
