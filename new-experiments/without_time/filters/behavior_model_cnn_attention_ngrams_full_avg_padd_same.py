...
def main(argv):
    ...
    ngram_2 = Convolution2D(200, (2, ACTION_EMBEDDING_LENGTH), padding='same',activation='relu', name = 'conv_2')(reshape)
    ngram_3 = Convolution2D(200, (3, ACTION_EMBEDDING_LENGTH), padding='same',activation='relu', name = 'conv_3')(reshape)
    ngram_4 = Convolution2D(200, (4, ACTION_EMBEDDING_LENGTH), padding='same',activation='relu', name = 'conv_4')(reshape)
    ngram_5 = Convolution2D(200, (5, ACTION_EMBEDDING_LENGTH), padding='same',activation='relu', name = 'conv_5')(reshape)
    ngram_2_3_attention = Attention()([ngram_2, ngram_3])
    ngram_2_4_attention = Attention()([ngram_2, ngram_4])
    ngram_2_5_attention = Attention()([ngram_2, ngram_5])
    ngram_average_2 = Average()([ngram_2_3_attention, ngram_2_4_attention, ngram_2_5_attention])
    ngram_3_2_attention = Attention()([ngram_3, ngram_2])
    ngram_3_4_attention = Attention()([ngram_3, ngram_4])
    ngram_3_5_attention = Attention()([ngram_3, ngram_5])
    ngram_average_3 = Average()([ngram_3_2_attention, ngram_3_4_attention, ngram_3_5_attention])
    ngram_4_5_attention = Attention()([ngram_4, ngram_5])
    ngram_4_2_attention = Attention()([ngram_4, ngram_2])
    ngram_4_3_attention = Attention()([ngram_4, ngram_3])
    ngram_average_4 = Average()([ngram_4_5_attention, ngram_4_2_attention, ngram_4_3_attention])
    ngram_5_2_attention = Attention()([ngram_5, ngram_2])
    ngram_5_3_attention = Attention()([ngram_5, ngram_3])
    ngram_5_4_attention = Attention()([ngram_5, ngram_4])
    ngram_average_5 = Average()([ngram_5_2_attention, ngram_5_3_attention, ngram_5_4_attention])
    maxpool_2 = MaxPooling2D(pool_size=(INPUT_ACTIONS,1), name = 'pooling_2')(ngram_average_2)
    maxpool_3 = MaxPooling2D(pool_size=(INPUT_ACTIONS,1), name = 'pooling_3')(ngram_average_3)
    maxpool_4 = MaxPooling2D(pool_size=(INPUT_ACTIONS,1), name = 'pooling_4')(ngram_average_4)
    maxpool_5 = MaxPooling2D(pool_size=(INPUT_ACTIONS,1), name = 'pooling_5')(ngram_average_5)
    #1 branch again
    ...
    dense_att_4 = Dense(200*200, activation='softmax', name='dense_att_4')(dense_att_3)
