...
def main(argv):
    ...
    ngram_2_3_attention = Attention(causal=True)([ngram_2, ngram_3])
    ngram_3_4_attention = Attention(causal=True)([ngram_3, ngram_4])
    ngram_4_5_attention = Attention(causal=True)([ngram_4, ngram_5])
    ngram_5_2_attention = Attention(causal=True)([ngram_5, ngram_2])
