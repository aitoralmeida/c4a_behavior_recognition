...
def main(argv):
    ...
    ngram_5_6_attention = Attention()([ngram_5, ngram_6])
    ngram_6_7_attention = Attention()([ngram_6, ngram_7])
    ngram_7_8_attention = Attention()([ngram_7, ngram_8])
    ngram_8_9_attention = Attention()([ngram_8, ngram_9])
    ngram_9_10_attention = Attention()([ngram_9, ngram_10])
    ngram_10_11_attention = Attention()([ngram_10, ngram_11])
    ngram_11_2_attention = Attention()([ngram_11, ngram_2])
