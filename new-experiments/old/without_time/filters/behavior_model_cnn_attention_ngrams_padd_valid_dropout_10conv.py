...
def main(argv):
    ...
    ngram_6 = Convolution2D(200, (5, ACTION_EMBEDDING_LENGTH), padding='valid',activation='relu', name = 'conv_6')(reshape)
    ngram_7 = Convolution2D(200, (5, ACTION_EMBEDDING_LENGTH), padding='valid',activation='relu', name = 'conv_7')(reshape)
    ngram_8 = Convolution2D(200, (5, ACTION_EMBEDDING_LENGTH), padding='valid',activation='relu', name = 'conv_8')(reshape)
    ngram_9 = Convolution2D(200, (5, ACTION_EMBEDDING_LENGTH), padding='valid',activation='relu', name = 'conv_9')(reshape)
    ngram_10 = Convolution2D(200, (5, ACTION_EMBEDDING_LENGTH), padding='valid',activation='relu', name = 'conv_10')(reshape)
    ngram_11 = Convolution2D(200, (5, ACTION_EMBEDDING_LENGTH), padding='valid',activation='relu', name = 'conv_11')(reshape)
    ...
    ngram_5_6_attention = Attention(dropout=0.8)([ngram_5, ngram_6])
    ngram_6_7_attention = Attention(dropout=0.8)([ngram_6, ngram_7])
    ngram_7_8_attention = Attention(dropout=0.8)([ngram_7, ngram_8])
    ngram_8_9_attention = Attention(dropout=0.8)([ngram_8, ngram_9])
    ngram_9_10_attention = Attention(dropout=0.8)([ngram_9, ngram_10])
    ngram_10_11_attention = Attention(dropout=0.8)([ngram_10, ngram_11])
    ngram_11_2_attention = Attention(dropout=0.8)([ngram_11, ngram_2])
    ...
    maxpool_5 = MaxPooling2D(pool_size=(INPUT_ACTIONS-5+1,1), name = 'pooling_5')(ngram_5_6_attention)
    maxpool_6 = MaxPooling2D(pool_size=(INPUT_ACTIONS-5+1,1), name = 'pooling_6')(ngram_6_7_attention)
    maxpool_7 = MaxPooling2D(pool_size=(INPUT_ACTIONS-5+1,1), name = 'pooling_7')(ngram_7_8_attention)
    maxpool_8 = MaxPooling2D(pool_size=(INPUT_ACTIONS-5+1,1), name = 'pooling_8')(ngram_8_9_attention)
    maxpool_9 = MaxPooling2D(pool_size=(INPUT_ACTIONS-5+1,1), name = 'pooling_9')(ngram_9_10_attention)
    maxpool_10 = MaxPooling2D(pool_size=(INPUT_ACTIONS-5+1,1), name = 'pooling_10')(ngram_10_11_attention)
    maxpool_11 = MaxPooling2D(pool_size=(INPUT_ACTIONS-5+1,1), name = 'pooling_11')(ngram_11_2_attention)
    #1 branch again
    merged = Concatenate(axis=2)([maxpool_2, maxpool_3, maxpool_4, maxpool_5, maxpool_6, maxpool_7, maxpool_8, maxpool_9, maxpool_10, maxpool_11])
    ...
    dense_att_4 = Dense(200*10, activation='softmax', name='dense_att_4')(dense_att_3)
