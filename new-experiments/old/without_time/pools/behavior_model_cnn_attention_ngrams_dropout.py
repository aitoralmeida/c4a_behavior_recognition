...
from keras.layers import Dot, Bidirectional, Concatenate, Attention, Convolution2D, Dense, Dropout, Embedding, Flatten, GRU, Input, Lambda, MaxPooling2D, Multiply, Reshape
...
def main(argv):
    ...
    maxpool_2_3_attention = Attention(dropout=0.8)([maxpool_2, maxpool_3])
    maxpool_3_4_attention = Attention(dropout=0.8)([maxpool_3, maxpool_4])
    maxpool_4_5_attention = Attention(dropout=0.8)([maxpool_4, maxpool_5])
    maxpool_5_2_attention = Attention(dropout=0.8)([maxpool_5, maxpool_2])
    #1 branch again
    merged = Concatenate(axis=2)([maxpool_2_3_attention, maxpool_3_4_attention, maxpool_4_5_attention, maxpool_5_2_attention])
