...
from keras.layers import Dot, Bidirectional, Average, Attention, Concatenate, Convolution2D, Dense, Dropout, Embedding, Flatten, GRU, Input, Lambda, MaxPooling2D, Multiply, Reshape
...
def main(argv):
    ...
    #1 branch again
    maxpool_avg = Average(name = 'average')([maxpool_2, maxpool_3, maxpool_4, maxpool_5])
    maxpool_2_attention = Attention()([maxpool_2, maxpool_avg])
