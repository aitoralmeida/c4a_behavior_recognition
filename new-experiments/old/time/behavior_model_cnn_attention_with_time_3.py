...
def main(argv):
    ...
    concat = Concatenate(axis=-1)([embedding_actions, input_time])

    bidirectional_gru = Bidirectional(GRU(512, input_shape=(INPUT_ACTIONS, ACTION_EMBEDDING_LENGTH + 2), name='bidirectional_gru'))(concat)
