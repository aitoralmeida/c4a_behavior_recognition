...
def main(argv):
    ...
    #attention mechanism
    dense_att_3 = Dense(128, activation='tanh', name='dense_att_3')(flatten1)
    ...
    apply_att_2 = Multiply(name='apply_att_2')([flatten1, dense_att_4])
    #reshape_att = Reshape((800,),name='reshape_att')(apply_att)
    #end attention
    #merge time-actions branches
    concat = Concatenate()([apply_att_2, flatten2])
