...
def main(argv):
    ...
    #attention mechanism
    dense_att_3 = Dense(128, activation='tanh', name='dense_att_3')(concat)
    # total units = 1 * INPUT_ACTIONS
    dense_att_4 = Dense(200*4 + 2*5, activation='softmax', name='dense_att_4')(dense_att_3)
    # apply the attention to the concat
    apply_att_2 = Multiply(name='apply_att_2')([concat, dense_att_4])
